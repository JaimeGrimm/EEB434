...
First we will reorganize how our data matrix is formatted.
### Question
Why do we do this? Think about the format your data needs to be in for further analyses
...
The assumptions of the one-factor ANOVA are:
1) Observations are independent and random 2) Data in each level of the groupings are normally distributed 3) The populations have common variances
